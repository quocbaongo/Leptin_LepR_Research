...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description = 'Plotting volume values distribution')
	parser.add_argument("--WTSampledValue", type=validate_file, help="File containing sampled values of WT structure (.txt)", required=True)
	parser.add_argument("--WTInitialValue", type=validate_file, help="File containing initial values of WT structure (.txt)", required=True)
	parser.add_argument("--MTSampledValue", type=validate_file, help="File containing sampled values of MT structure (.txt)", required=True)
	parser.add_argument("--MTInitialValue", type=validate_file, help="File containing initial values of MT structure (.txt)", required=True)	
