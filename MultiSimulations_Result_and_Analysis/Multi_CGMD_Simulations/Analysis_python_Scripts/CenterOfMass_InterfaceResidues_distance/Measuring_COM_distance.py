...
def MeasuringDistance_function(u,ts,ListRes1,ListRes2,FileOut):
	...
	Selection1=''
	for res in ListRes1:
	    Selection1+=f'(resid {int(res[0])} and segid {res[2]} and name BB) or '
	...
	Selection2=''
	for res in ListRes2:
	    Selection2+=f'(resid {int(res[0])} and segid {res[2]} and name BB) or '
...
if __name__ == '__main__':
	...
	parser.add_argument("-File_Out", help="Name of output file", required=True)
