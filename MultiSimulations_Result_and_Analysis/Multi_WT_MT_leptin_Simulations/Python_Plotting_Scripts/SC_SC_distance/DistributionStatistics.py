...
if __name__ == '__main__':
	...
	parser.add_argument('--SampledDistanceFile', type=validate_file, help='File containing sampled distance in Å (.txt)', required=True)
	parser.add_argument('--InitialDistance', type=validate_file, help='File containing initial distance in Å (.txt)', required=True)
